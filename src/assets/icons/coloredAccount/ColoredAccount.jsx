...
import styles from './ColoredAccount.module.css'

const ColoredAccount = () => {
    return (
        <svg className={styles.self} viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
