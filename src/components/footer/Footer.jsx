        ...
        <footer className={`${styles.self} container`}>
            <div>
                <div className={styles["logo-container"]}>
                    ...
                    <div className={styles["social-networks"]}>
                        <div>
                            <a href="https://www.instagram.com/curiosityoquvmarkazi/" target="_blank" rel="noreferrer">
                                <Instagram/>
                            </a>
            ...
            <div className={styles.copyright}>
                ...
                <div className={styles.developer}>
                    <a href="https://primeteam.uz/uz" target="_blank" rel="noreferrer">PrimeTeam</a> tomonidan ishlab
                    chiqarilgan
                </div>
            </div>
        </footer>
